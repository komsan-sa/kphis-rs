...
#set page(paper:"a4",margin:(x:1.5cm,y:2cm),header: [#h(1fr)แบบ ใบสั่งจ่าย ย.ส.๒/ว.จ.๒])
#v(20pt)
#align(center,text(size:18pt,weight:700,[ใบสั่งจ่ายยาเสพติดให้โทษในประเภท ๒ หรือวัตถุออกฤทธิ์ในประเภท ๒]))
#v(20pt)
#grid(columns:(1fr,1fr),[],[วันที่ #date_th_full(order_item.order_date)])
#v(20pt)
#h(55pt)ข้าพเจ้า #order_item.order_doctor_name ใบอนุญาตประกอบวิชาชีพ#license_type(order_item.order_doctor_licenseno)ชั้นหนึ่ง เลขที่ #order_item.order_doctor_licenseno ปฏิบัติงาน ณ สถานพยาบาลชื่อ #hospital-name ตั้งอยู่เลขที่ #hospital-address
#v(0pt)
#h(55pt)#underline(strong[ขอสั่งจ่าย]) #if is_addict [#sym.ballot.cross] else [#sym.ballot] ยาเสพติดให้โทษในประเภท ๒ #if is_addict [#sym.ballot] else [#sym.ballot.cross] วัตถุออกฤทธิ์ในประเภท ๒ ดังรายการดังต่อไปนี้ 
#table(columns:(35pt,100pt,80pt,60pt,120pt,1fr),stroke:.5pt,
  table.header(
  ...
  ),align(center,[๑]),[#med_name],[],align(center,[#stregnth]),[#order_item.order_item_detail],align(center,[#h(10pt)#unit]),
)
#v(10pt)
...
2. ให้ผู้รับการรักษาหรือเจ้าของสัตว์ซึ่งรับการรักษา ส่งมอบต้นฉบับของเอกสารฉบับนี้ให้แก่สถานพยาบาลที่จ่ายยาเสพติดให้โทษหรือวัตถุออกฤทธิ์ตามใบสั่งจ่ายให้ และให้สถานพยาบาลที่จ่ายยาเสพติดให้โทษหรือวัตถุออกฤทธิ์เก็บรักษาเอกสารฉบับนี้ไว้ เพื่อเป็นหลักฐานประกอบการจ่ายยาเสพติดให้โทษหรือวัตถุออกฤทธิ์
...
#box(stroke: .5pt + black, inset: 9pt, text(12pt, [ผู้รับอนุญาตจำหน่าย จะจำหน่ายยาเสพติดให้โทษในประเภท ๒ หรือวัตถุออกฤทธิ์ในประเภท ๒ ให้แก่บุคคลภายนอกที่ไม่ใช่ผู้ป่วยหรือสัตว์ป่วยซึ่งตนให้การรักษาได้ เฉพาะกรณีที่มีใบสั่งจ่ายยาเสพติดให้โทษในประเภท ๒ หรือวัตถุออกฤทธิ์ในประเภท ๒ จากผู้ประกอบวิชาขีพเวชกรรม ผู้ประกอบวิชาขีพทันตกรรม หรือผู้ประกอบวิชาชีพการสัตวแพทย์ชั้นหนึ่ง แล้วแต่กรณี]))